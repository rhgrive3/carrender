...
assert.doesNotMatch(home, /Input／Output差|Composition|Context/u, 'ホームへ専門的な分析を出さない');
...
assert.doesNotMatch(result, /苦手分析|Learning Target|Composition|Context/u, '結果画面から分析導線と専門用語を削除する');
