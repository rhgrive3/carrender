...
assert.match(main, /installMemoryImportTabPanelSemantics\(\);/u, 'アプリ起動時に暗記取込tabpanel契約を有効化する');
...
const executableGuard = ts.transpileModule(
  `${source
    .replace(/export function normalizeMemoryImportTabPanels/u, 'function normalizeMemoryImportTabPanels')
    .replace(/export function installMemoryImportTabPanelSemantics/u, 'function installMemoryImportTabPanelSemantics')}\ninstallMemoryImportTabPanelSemantics();`,
