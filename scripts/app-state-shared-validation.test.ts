...
const normalizedValidSession = { ...validSession, taskSnapshotBefore: undefined };
...
assert.deepEqual(importedZeroMinute.sessions, [normalizedValidSession], 'JSON importでも0分記録だけを除外して残りを復元する');
