...
assert.match(guard, /attributeFilter: \['aria-checked', 'aria-selected', 'disabled', 'role'\]/, 'React再描画後も両ARIA選択状態のroving tabindexを再正規化する');
...
console.log('✅ Segmented, repaired radiogroup, and tablist accessibility contracts passed');
