...
assert.match(source, /return !element\.parentElement\?\.closest\('\[hidden\], \[inert\], \[aria-hidden="true"\]'\)/, 'hidden screen-label markers must stay selectable while labels behind inactive ancestors are ignored');
