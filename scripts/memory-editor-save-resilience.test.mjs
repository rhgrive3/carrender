...
assert.match(source, /const saveInFlight = useRef\(false\)[\s\S]*if \(!repository \|\| saveInFlight\.current \|\| loadError\) return;[\s\S]*saveInFlight\.current = true/u, 'カード保存を再描画前からsingle-flight化する');
